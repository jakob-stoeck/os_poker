...
function	os_poker_buddies_page($action = NULL, $page=0)
{
	...
	switch ($action)
	{
		...
		case "invitefb":
			...
			$output .= '<div style="height:420px;overflow:hidden">'.str_replace('<fb:multi-friend-selector','<fb:multi-friend-selector rows="3" cols="4"',$block['content']).'</div>';
