				...
				<div id="middle-content">
					<div id="middle-content-left">
						<div class="banner-box">
							<a href="<?php print url("", array('fragment' => "tourney_serial=1387")); ?>" id="banner-tourney"><!-- --></a>
						</div>
						<div class="banner-box">
							<a href="<?php print url("", array('fragment' => "tourney_serial=1387")); ?>" id="banner-millions"><!-- --></a>
						</div>
