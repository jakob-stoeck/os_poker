...
DESC="Process scheduled live events for os_poker"
NAME=live-events-processor
DAEMON=/usr/src/drupal6/sites/all/modules/os_poker/scripts/run-live-events-processor
DAEMON_ARGS=""
...
do_start()
{
	...
	start-stop-daemon --start --quiet --name $NAME --exec $DAEMON --test > /dev/null \
		|| return 1
	start-stop-daemon --start --name $NAME --exec $DAEMON -- $DAEMON_ARGS \
		|| return 2
