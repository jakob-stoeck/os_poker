...
The winner with the best five-card hand is now determined from among the remaining players who have not folded. The number of hole cards a player has used has no bearing on whether they win the round. Also see: Poker hand rankings </li>
	...
	<div id="help-getting-chips" class="helpbox">
		...
		<ul class="helpbox-list">
			...
			Just visit the game and you're automatically entered into the daily lottery!</li>
			<li><strong>Daily bonus chips</strong><br />
			Obtain free bonus chips every day that you log in.<br />
			The more buddies you have the more chips you get.</li>
			<li><strong>Play Poker</strong><br />
			Win chips at the table und get extra chips for rewards.<br />
			You can get rich faster by playing higher stakes but of course you can loose it all.</li>
			<li><strong>Instant Chip Upgrade</strong><br />
			Finally you can buy or earn chips to upgrade your chip stack hassle-free. </li>
		</ul>
		</div>
	</div>
