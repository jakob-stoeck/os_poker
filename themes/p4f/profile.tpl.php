		...
		<div class="right fleft">
			<div>
				<table cellspacing="0" cellpadding="0" class="TableRanking">
					...
					<tr>
						<td colspan="2" class="block_title_bar block_title_text Column02">Spieler Profil</td>
						<td colspan="2" class="block_title_bar block_title_text">Poker Profil</td>
					</tr>
            ...
            <div class="right">
			  ...
			  <div onclick='javascript:os_poker_trigger("os_poker_jump", {url:"<?php print url("poker/profile/update"); ?>", lightbox:false});' class="poker_submit profile-up-submit">
				<div class="pre">&nbsp;</div>
...
<!-- middlebottom placeholder -->
	<div class="bottom">
		...
		<? // Hide the tournament stuff ?>
		<div class="right fleft hidden">
